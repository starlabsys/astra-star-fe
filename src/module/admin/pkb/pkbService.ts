...
// import { usePkbContext } from '@/src/context/PkbContext';
import { usePkbContext } from '@/src/app/(admin)/pkb/PkbContext';
import { uploadExcel } from '@/src/repository/pkb/pkbRepository';
import { JSONDataPkb, PekerjaanInterface } from '@/src/types/PkbExportInterface';
...
export const usePkbService = () => {
  ...
  const uploadData = async (data: PkbData[]) => {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      let splitDataSukuCadang = data[i].sukuCadang ? data[i].sukuCadang.split("|") : [];
    ...
    const dataUpload = {
      "tokenAntrian" : "eyJhbGciOiJSUzI1NiIsImtpZCI6IkUwM0FBMkNEMzQ1OTE5NkIxNDBEMzVEQUFGOEY3OUQ3IiwidHlwIjoiYXQrand0In0..f7iGV2bShhdzu2DE9C50WnAtydNFOLez5jrNrC5BIsfph7bKOkKE1A0jpuS2AZQLd_aI5--gy6na747g6e7jjzPDlSGyGUrE725zMnLDX5WcYl3kozv_ZAhcq4PtAvi1BLi4Ygo5wdSdW-tBtpUMD2swTz7Zrgx4cAI_PJGofB5Y1VR3pC7BaOCzeg6rjZkxcwvZKMT4iHWWzAO6JRv9CrRjMigsapTcNsMK_UdLpHJGZOIWm46CshlshYGr76ZPbVxYkqYCw-R2UY4m0dDw1Bk_O9baCvQO0CYDgTK7yeESYbENgqkZ1g5zCaNyiaoQHd7_Cxp7GMZvdEWz_dpRqA",
      "tokenWork" : "eyJhbGciOiJSUzI1NiIsImtpZCI6IkUwM0FBMkNEMzQ1OTE5NkIxNDBEMzVEQUFGOEY3OUQ3IiwidHlwIjoiYXQrand0In0..M5nBeUBQHGG6i4TQi1plwui3EfnygGvaUKqHBrh_4OH59Npka6UnZZ9yQLU5X6lDxWS9qwky2L2aijS_KCTv6FtNvwR4HYCOAMAvcyb0ksSNszvf51adjfDRDbe4JO6lPI3oyc-WVD2rbSe2BoXd8co0CqfS2o7CX0SIVzGE3rw1Aviq_GdFAcmh6-BvcfL22XUjV_rn2D3AvYcYW4S9Fzl9lSoJSiGfAXqy48aU8qG7mS-hjA0Uh440avHOjoH8Q0kShraIByjQJuAN_-U36XpySDzXt7ovYyH9GnBtL70bE9Ab-o6fVhpYIsVysSf1hEZrL5XtXsDPNRFlwTmo5A",
      "jsonData" : jsonData
    };
